...
- Tests: `python3 -m pytest -q`, `python3 -m ruff check .`, `python3 -m mypy .`, `python3 -m streamlit run credit_spread_system/app/main.py --server.headless true --server.port 8503`.
